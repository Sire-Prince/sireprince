          ...
          <FadeRight>
            <div className="w-full">
              <div className="mb-6">
                ...
                <p className="text-sm" style={{ color: colors.textMuted }}>Fill out the form and we'll get back to you shortly.</p>
              </div>
              ...
              {isSubmitted ? (
                <div className="rounded-xl p-6 text-center" style={{ 
                  ...
                  <p className="text-xs" style={{ color: colors.textMuted }}>Thank you for reaching out. We'll get back to you within 24 hours.</p>
                </div>
              ) : (
